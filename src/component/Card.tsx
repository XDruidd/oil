...
function Card(_card : ICard){
    ...
    return(
        <>
            <Box sx={{border: "1px solid #00000033", maxWidth: "374px", maxHeight: "400px",  width: "100%", height: "100%", borderRadius: "35px"}}>
                <Box sx={{padding:"0.5rem 1rem"}}>
                    <Box sx={{display: "flex", justifyContent: "space-between"}}>
                        <Box sx={{width: "70%", display: "flex", flexDirection: "column", gap:"10px"}}>
                            <Typography fontSize="18px">{_card.name}</Typography>
                ...
                <Box sx={{
                    ...
                    <Typography sx={{display: "flex", justifyContent:"end"}} fontSize="12px" color="#14141280">id: {_card.id}</Typography>
                </Box>
            </Box>
        </>
    )
